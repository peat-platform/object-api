...
var getName = function(path){
   ...
   /**
   * parts[0]  =  "data"      : "value", Root path defined by Mongrel
   * parts[1]  =  "v1"        : "value", API Version  
   * parts[2]  =  "data"      : "value", required by Documentation
   * parts[3]  =  cloutled_x  : ID of cloudlet to be accessed
   * parts[4]  =  object_id_x : Object to be returned from cloudlet_x 
   **/
   if (parts.length >= 3){
      return parts[3]
   }
