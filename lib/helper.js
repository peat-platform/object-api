...
var genPostMessage = function(msg, senderToDao, senderToClient, terminal_handler){
   ...
   var objectRestURL     = "http://" + msg.headers.host + '/api/v1/objects/' + cloudletId + '/' + objectId;

   var type = msg.json['@openi_type'];

   if(type.indexOf("t_") === 0) msg.json['@openi_type'] = "http://" + msg.headers.host + "/api/v1/types/" + type;
